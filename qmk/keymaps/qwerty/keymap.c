...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    LAYOUT( /* Base */
        ...
        KC_BSPC, KC_MINS, KC_P, KC_O, KC_I, KC_U, KC_Y,
        KC_ENT, KC_QUOT, KC_SCLN, KC_L, KC_K, KC_J, KC_H,
        KC_UP, KC_SLSH, KC_DOT, KC_COMM, KC_M, KC_N,
    ...
    LAYOUT( /* layer 1 */
        ...
        KC_PGUP, KC_PIPE, KC_PLUS, KC_TRNS, KC_TRNS, KC_TRNS,
        KC_PGDN, KC_END, KC_HOME, KC_TRNS, KC_TRNS),
    LAYOUT( /* layer 2 */
        ...
        KC_PGUP, KC_BSLS, KC_EQL, KC_TRNS, KC_TRNS, KC_TRNS,
        KC_PGDN, KC_END, KC_HOME, KC_TRNS, KC_TRNS),
};
